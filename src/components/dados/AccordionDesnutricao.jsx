...
import accordionsData from '../../json/accordionsDesnutricao.json';

const AccordionDesnutricao= () => {
...
// <img src={accordion.imageUrl} alt={accordion.title} />
export default AccordionDesnutricao;
